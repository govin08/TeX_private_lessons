...
함수 \(f(x)=\begin{cases}x+1&(x<1)\\1&(x\ge1)\end{cases}\)와 실수 \(1\)에 대해
\begin{enumerate}
\item
\(f(1)\)이 존재한다(\(=2\)).
\item
\(\displaystyle\lim_{x\to 1}f(x)\)가 존재하지 않는다.\\
(좌극한과 우극한이 일치하지 않기 때문이다.)
\item
\(\displaystyle f(1)=\lim_{x\to 1}f(x)\)가 성립하지 않는다.
\end{enumerate}
따라서 \(f(x)\)는 \(x=1\)에서 연속이 아니다.
}
...
함수 \(\displaystyle f(x)=\frac{-x^2+2x}x\)와 실수 \(0\)에 대해
\begin{enumerate}
\item
\(f(0)\)이 존재한다(\(=\pb{1}\)) / 존재하지 않는다.
\item
\(\displaystyle\lim_{x\to 0}f(x)\)가 존재한다(\(=\pb{1}\)) / 존재하지 않는다.
\item
\(\displaystyle f(0)=\lim_{x\to 0}f(x)\)가 성립한다 / 성립하지 않는다.
\end{enumerate}
따라서 \(f(x)\)는 \(x=0\)에서 연속이다 / 연속이 아니다.
}
...
\item
\(y=\displaystyle\frac{x^2-3x+2}{|x-2|}\)는 \(x=1\)에서 연속이다 / 연속이 아니다.
\end{enumerate}
